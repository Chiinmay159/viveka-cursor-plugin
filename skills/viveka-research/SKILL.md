...
description: Research and analysis discipline. Use when the task requires finding, evaluating, and synthesizing information — market research, technical investigation, competitive analysis, fact-checking. Covers source hierarchy, search strategy, and evidence standards.
---
...
## Output
- **For decisions:** lead with recommendation, key evidence, risks, sources.
- **For exploration:** landscape of positions, where consensus exists and doesn't, surprises.
